/* PrismJS 1.28.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+java+javadoc+javadoclike+javastacktrace&plugins=line-highlight+line-numbers+highlight-keywords */
...
!function () {
    if ("undefined" != typeof Prism && "undefined" != typeof document && document.querySelector) {
            ...
            highlightLines: function (r, a, u) {
                var c = (a = "string" == typeof a ? a : r.getAttribute("data-line") || "").replace(/\s+/g, "").split(",").filter(Boolean),
                    d = +r.getAttribute("data-line-offset") || 0, h = (function () {
                        ...
                        return e;
                    }() ? parseInt : parseFloat)(getComputedStyle(r).lineHeight), f = Prism.util.isActive(r, t),
                    p = r.querySelector("code"), g = f ? r : p || r, m = [], v = p && g != p ? function (e, t) {
                ...
                c.forEach((function (e) {
                    ...
                    if (m.push((function () {
                        ...
                        var s = Prism.plugins.lineNumbers.getLine(r, i), l = Prism.plugins.lineNumbers.getLine(r, n);
                        if (s) {
        ...
        Prism.hooks.add("before-sanity-check", (function (e) {
            ...
            if (a(n)) {
                clearTimeout(r);
                var o = Prism.plugins.lineNumbers, l = i.plugins && i.plugins.lineNumbers;
    ...
    function u() {
        ...
        if (t && !document.getElementById(e)) {
            var i = e.slice(0, e.lastIndexOf(".")), r = document.getElementById(i);
